        ...
        `(,(make-mu4e-context
          ...
          ,(make-mu4e-context
            ...
            :vars '(
                    ...
                    (mu4e-sent-folder . "/office-arc/Sent Mail")
                    (mu4e-trash-folder . "/office-arc/Deleted")
...
#+begin_src emacs-lisp
  ...
  ;;   '(("/lokesh-gmail/Inbox"      . ?i)
  ;;     ("/lokesh-gmail/Sent Items" . ?s)
  ;;     ("/lokesh-gmail/Drafts"     . ?d)
  ;;     ("/lokesh-gmail/Trash"      . ?t)))
