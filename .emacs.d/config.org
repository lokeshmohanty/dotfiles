...
#+begin_src emacs-lisp
  ...
  (use-package vertico
    :bind (:map vertico-map
                ...
                ("C-b" . my/minibuffer-backward-kill))
    :custom 
    (vertico-cycle t)
    :init
    (vertico-mode)
...
** Org Custom Link Types

#+begin_src emacs-lisp

  (org-link-set-parameters "stack.exchange" "https://emacs.stackexchange.com/a/")
...
* REFERENCES
** [[https://gitlab.com/dwt1/dotfiles/-/blob/master/.emacs.d.gnu/config.org][Distrotube's GNU Emacs]]
...
*** [[https://www.youtube.com/playlist?list=PLEoMzSkcN8oM-kA19xOQc8s0gr0PpFGJQ][Emacs Mail]]
*** [[https://www.youtube.com/playlist?list=PLEoMzSkcN8oNvsrtk_iZSb94krGRofFjN][Emacs IDE]]
*** [[https://www.youtube.com/playlist?list=PLEoMzSkcN8oMc34dTjyFmTUWbXTKrNfZA][Mastering Git with Magit]]
** [[https://www.youtube.com/playlist?list=PLhXZp00uXBk4np17N39WvB80zgxlZfVwj][Zaiste Programming: DoomCasts]]
** [[https://jonathanabennett.github.io/blog/2019/05/28/emacs.org-~-may-2019/][Jonathan Bennett's Emacs.org]]
